...
public class UserModule_SD {
	...
	public UserModule_SD(TestContextSetup context) {
		this.context = context;
		//usermodule = context.getpageobjectmanager()();
...
//				emailadress, postGrad, timeZne, usrComnts);
	...
	public void admin_gets_message(String expectdMsg) {
		Assert.assertEquals(usermodule.verifySuccessMsg(expectdMsg), true);
	}
